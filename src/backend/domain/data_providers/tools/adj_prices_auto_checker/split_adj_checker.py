...
parser = argparse.ArgumentParser(
    prog="SplitAdjustedPricesAutoChecker",
    description="CLI tool for compairing twelve split adjusted prices to alphavantage split adjusted prices",
)
...
parser.add_argument(
    ...
    default="10 years",
    nargs="?",
    help="Data fetch time range (10y is default)",
)
...
def get_data(tickers: List[str], start_date: str, end_date: str) -> Tuple[Dict[str, Any], Dict[str, Any]]:
    ...
    alph_data = alphavantage_provider.get_parallel_split_adjusted_prices(tickers, start_date, end_date, "1day")

    twlv_data = twelve_provider.get_parallel_split_adjusted_prices(tickers, start_date, end_date, "1day")
